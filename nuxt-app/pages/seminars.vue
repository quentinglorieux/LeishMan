<template>
  ...
  <div v-if="nextseminar">
    <Titleheader class="p-10" title="Coming soon"></Titleheader>
  ...
  <div id="seminar" class="p-10 bg-slate-200 text-gray-800 dark:bg-slate-400">
    ...
    <div class="flex flex-wrap sbt">
      <div class="col" v-for="(seminar, index) in futureseminars" :key="index">
        <CardL
          v-if="index % 2 == 1"
          :title="seminar.title"
  ...
  <div id="seminar" class="p-10 bg-slate-200 text-gray-800 dark:bg-slate-400">
    <Titleheader title=" Past Seminars"></Titleheader>
    <p class="m-10"></p>
    <div class="flex flex-wrap sbt">
      <div class="col" v-for="(seminar, index) in pastseminars" :key="index">
        <CardL
          v-if="index % 2 == 1"
          :title="seminar.title"
          :location="seminar.location"
...
const pastseminars = seminars.filter((event) => new Date(event.date) < today);
</script>
